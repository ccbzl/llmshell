...
def test_kimi_multi_tool_calls():
    """测试 Kimi-k2.5 模型的多个工具调用"""
    print("=" * 60)
    print("测试 Kimi-k2.5 模型的多个工具调用功能")
    print("=" * 60)
    
    # 创建 LLM Shell 实例，使用 Kimi 模型
    shell = LLMShell(
        model_provider="kimi",
        model="kimi-k2.5",
