...
def test_actual_input():
    ...
    # 模拟实际程序的输入方式
    test_prompt = "echo \"请执行以下任务：1. 列出当前目录下的文件和文件夹，2. 读取 README.md 文件的内容（如果存在）\" | python llmshell.py"
    ...
    # 构建历史文本（模拟实际程序的方式）
    shell.history.append({"role": "user", "content": test_prompt})
    history_text = ""
    for msg in shell.history[-10:]:
